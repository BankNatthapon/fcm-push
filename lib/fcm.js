...
FCM.prototype.send = function(payload, CB) {
    ...
    return new Promise(function (resolve, reject){
        ...
        // var mFcmOptions = JSON.parse(JSON.stringify(self.fcmOptions)); // Not working with agent -> Error : TypeError: Agent option must be an Agent-like object, undefined, or false.
        var mFcmOptions = Object.assign({}, self.fcmOptions);
